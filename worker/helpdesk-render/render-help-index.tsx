            ...
            {props.popularArticles.length > 0 && (
              <aside class="hidden lg:block">
                <div class="rounded-xl bg-muted overflow-hidden">
                  <h2 class="flex items-center gap-2 px-4 pt-4 pb-2 text-sm font-semibold text-foreground">
                    <HelpIcon name="TrendingUp" class="h-4 w-4 text-primary" />
                    Popular Articles
                  </h2>
                  <ul>
                    {props.popularArticles.map(({ article, category }) => (
                      <li>
                        <a
                          class="group flex items-center justify-between gap-3 px-4 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
                          href={buildHelpUrl({
                            projectSlug: props.project.slug,
                            customUrl: props.helpCustomUrl,
                            category: category.slug,

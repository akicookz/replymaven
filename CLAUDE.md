...
export class FooService {
  ...
  async createFoo(
    data: Omit<NewFooRow, "id" | "createdAt" | "updatedAt">,
  ): Promise<FooRow> {
...
export const foos = sqliteTable(
  ...
  (table) => [index("idx_foos_user").on(table.userId)],
);
...
- Always make implementation plans and project exploration using @agent-planner and after your changes always get your changes reviewed by @agent-code-reveiwer
- Never write to a file without reading it start to end first - always.

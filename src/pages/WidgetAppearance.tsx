...
const PAGE_DESCRIPTION =
  "Colors, layout, typography, and background treatment.";
...
function WidgetAppearance() {
  ...
  // Legacy URL: /widget?tab=greetings now has its own page
  if (searchParams.get("tab") === "greetings") {
    return (
      <Navigate
        to={`/app/projects/${projectId}/widget/greetings`}
        replace
      />
    );
  }
  ...
  return (
    ...
    >
      <WidgetSectionCard
        title="Branding"
        description="Colors and header copy shown across the widget."
        icon={Palette}
      >
